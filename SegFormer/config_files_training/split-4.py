...
evaluation = dict(interval=10, metric='mDice', save_best='mDice', ignore_index=0, by_epoch=True,     
                        outdir='/home/ws/oc9627/mmsegmentation/work_dirs/2d_ms_org_seg_run4_downscale025/split-4/eval_imgs')    
log_config = dict(    
            interval=10,    
            hooks=[    
...
work_dir='/home/ws/oc9627/mmsegmentation/work_dirs/2d_ms_org_seg_run4_downscale025/split-4'
